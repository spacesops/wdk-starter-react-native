...
After changing src/, run npm run emit:lib in the provider (or rely on npm install / prepare in a clean clone). Pre-generated wdk-worklet.mobile.bundle.js / wdk-secret-manager-worklet.bundle.js under lib/module/services/wdk-service/ are left as-is; only files produced from src are overwritten.
